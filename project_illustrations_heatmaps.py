...
if __name__ == '__main__':
    ...
    f, axes = plt.subplots(nrows = 6, ncols = 4, figsize = (15, 15))
    ...
    for i, idx in enumerate(img_indices):
        ...
        axes[i, 1].set_title('Raw heatmap')
        axes[i, 2].imshow(heatmaps.weighted_average(), cmap = 'hot')
        axes[i, 2].set_title('Averaged heatmap (over 3 frames)')
        axes[i, 3].imshow(thresholded_hm, cmap = 'hot')
        axes[i, 3].set_title('Thresholded avg heatmap')
